...
def create_introduccion(styles):
    ...
    """
    story.append(Paragraph(intro_text2, styles['CustomBodyText']))
    ...
    """
    story.append(Paragraph(intro_text3, styles['CustomBodyText']))
...
def create_consejos(styles):
    ...
    for idx, consejo in enumerate(consejos):
        ...
        for parrafo in consejo['contenido']:
            story.append(Paragraph(parrafo, styles['CustomBodyText']))
...
def create_cierre(styles):
    ...
    """
    story.append(Paragraph(cierre_text, styles['CustomBodyText']))
