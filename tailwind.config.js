  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "card-hover": "0 16px 40px -12px rgba(184,71,46,0.28), 0 4px 16px -4px rgba(0,0,0,0.1)",
        "gold-glow": "0 8px 24px -6px rgba(201,151,74,0.35)",
      },
      borderRadius: {
        xl: "1rem",
        "2xl": "1.25rem",
      ...
      backgroundImage: {
        ...
        "azulejo-pattern-gold": "url('data:image/svg+xml,%3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fill-rule=\"evenodd\"%3E%3Cg fill=\"%23C9974A\" fill-opacity=\"0.07\"%3E%3Cpath d=\"M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')",
      },
    },
  },
  plugins: [],
