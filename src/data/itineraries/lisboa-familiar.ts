...
export const lisboaFamiliarTimeline: TimelineStop[] = [
  ...
  },
  {
    ...
    tip: '🚋 Billete: 3,30€ en el conductor (solo efectivo) o 1,50€ con tarjeta Viva Viagem (mucho más barato). MEJOR HORARIO: 9:00-11:00 o después de las 18:00 (menos turistas, más espacio). Evita 12:00-17:00 que va REPLETO. Si queréis ir sentados, subid en Martim Moniz (inicio) o Campo de Ourique (final). El recorrido completo dura 40-45 minutos. Perfecto para tomar fotos desde la ventanilla. Los niños menores de 4 años van gratis en el regazo.',
    type: 'visit',
  ...
  },
  {
    ...
    tip: '🏰 Torre de Belém: adultos 15€. Consulta en la web oficial las reducciones para menores y estudiantes, que cambian con frecuencia. Horario: 10:00-18:30 (verano hasta 19:30). Lunes cerrado. Subida: escaleras estrechas, niños pequeños con supervisión. PASTÉIS DE BELÉM: 1.30€/pastel, café 1€. TRUCO: Entra directo a "Salão" (evitas cola de 30-60 min). Jardines: GRATIS, perfecto para picnic. Tiempo total: 2-2.5 horas.',
    type: 'visit',
