...
export const lisboa3DiasSintraTimeline: TimelineStop[] = [
  ...
  },
  {
    ...
    tip: '🌅 TIMING CRÍTICO: Llega 45-60 min ANTES del sunset (consulta hora). Mesitas primera fila se llenan RÁPIDO. Fin de semana = llega 1 hora antes. Quiosco horario: hasta 22:00. Si está repleto: Mirador Santa Luzia (igual de bonito, 10 min caminando). Lleva chaqueta - refresca después del sol.',
    type: 'visit',
  ...
  },
  {
    ...
    tip: '🥐 Travesseiros Piriquita: imperdibles, solo se hacen aquí. Piriquita I (original, Rua Padarias 1, más auténtico) vs Piriquita II (más grande, mejor para sentarse si estás cansado). TAMBIÉN PRUEBA: Queijadas de Sintra (tartaletas de queso dulce, también especialidad local). Centro Sintra: GRATIS pasear, no hay entrada a nada. Tiendas cierran 19:00-19:30. Regreso Lisboa: Tren hasta 23:00 aproximadamente (cada 20-30 minutos). Cena en Lisboa —llegas alrededor de las 19:30 con tiempo para cenar tranquilo. Si quieres cenar en Sintra antes de volver, hay buenos restaurantes en el centro pero son más caros que en Lisboa.',
    type: 'food',
