...
export const lisboa3DiasSintraTimeline: TimelineStop[] = [
  ...
  },
  {
    ...
    tip: '☕ LandScape café: vistas al puente y café de especialidad. By The Wine: vinos portugueses en un local pequeño y tranquilo. Ler Devagar librería: cierra 20:00 —no llegues tarde si quieres verla, es espectacular. Domingos: mercado vintage 11:00-19:00 con ropa, vinilos, artesanías. "Rio Maravilha" restaurante: terraza con vistas al puente. TODO es instagrameable aquí —los grafitis, la arquitectura industrial, las terrazas, todo.',
    type: 'visit',
  ...
  // DÍA 3 - SINTRA COMPLETO
  {
    ...
    description: 'Día 3 es tu excursión a Sintra —el pueblo de palacios de colores escondido en las montañas a cuarenta minutos de Lisboa que parece sacado de un cuento de hadas. Sal TEMPRANO. Esto es crítico y no es una exageración. Coge el tren desde la Estación Rossio (centro de Lisboa, fácil de llegar en metro línea verde) hacia Sintra —salen cada veinte minutos desde las 6:30 de la mañana. Compra billete de ida y vuelta en las máquinas automáticas de la estación (aceptan tarjeta y efectivo); la tarifa vigente está en la web de CP. El viaje dura cuarenta minutos atravesando suburbios lisboetas, campos verdes, y finalmente montañas cubiertas de bosque hasta llegar al pueblo de Sintra, que aparece como una visión entre la neblina. Cuando bajes del tren, NO camines al centro todavía —ese es el error que cometen todos y que te hará perder tiempo. Ve DIRECTO a los autobuses que están junto a la estación: el 434 (circular que sube al Palacio da Pena y al Castelo dos Mouros) o el 435 (va a Quinta da Regaleira). Cómpralos en el kiosco junto a la estación antes de que se forme cola. La clave de Sintra es simple: llega temprano (antes de las 9:00) y usa los buses —las colas después de las 11:00 son demenciales (una o dos horas para entrar a los palacios, literalmente). Sintra es una fantasía completa —neblina frecuente en las montañas que añade misterio, palacios de colores imposibles que parecen de Disney, jardines laberínticos con túneles secretos, bosques encantados con árboles exóticos traídos de todo el mundo, y una atmósfera que Lord Byron describió como "el paraíso en la tierra". Vas a sentir que entraste a un cuento de hadas, y no es una metáfora —es exactamente así.',
