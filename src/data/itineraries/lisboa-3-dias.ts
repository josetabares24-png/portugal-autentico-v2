...
export const lisboa3DiasSintraTimeline: TimelineStop[] = [
  ...
  },
  {
    ...
    description: 'Desde el mirador son diez minutos de subida hasta la puerta, y vale la pena hacerlos: el castillo no es sólo una fortaleza, es el sitio donde empezó Lisboa. Esta colina lleva ocupada casi tres mil años —fenicios, romanos, visigodos, moros y los cristianos desde 1147— y lo que se recorre hoy es sobre todo la muralla musulmana del siglo XI. Arriba hay tres cosas que no conviene saltarse. Las murallas, con once torres que se recorren por lo alto y la Baixa a tus pies mientras el Tajo se abre hacia el Atlántico. La cámara oscura de la Torre de Ulises, que proyecta la ciudad en tiempo real y es la mejor forma de entender cómo está montada. Y, sin ningún mérito histórico, los pavos reales sueltos por los jardines, que llevan décadas ahí y son lo que más recuerdan los niños. Calcula entre hora y media y dos horas: hay yacimiento arqueológico, jardines y muralla, y todo se anda. Al terminar bajas hacia la Baixa, que es la siguiente parada.',
  ...
  // DÍA 2 - BELÉM COMPLETO
  {
    ...
    tip: '🎫 Existe billete combinado con el Monasterio dos Jerónimos: comprueba en la web oficial el precio vigente de cada uno y del combinado antes de decidir. HORARIO: 10:00-17:30 (oct-abr), 10:00-18:30 (may-sep). Lunes CERRADO. Compra online para saltarte cola. Escaleras MUY estrechas - no apto para claustrofobia o movilidad reducida. Julio-agosto = llega 9:45 para ser de los primeros.',
    type: 'visit',
    image: 'https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=800',
  ...
  },
  {
    ...
    tip: '💰 IGLESIA: GRATIS (imperdible). CLAUSTRO: 18€ (bonito pero opcional). Si hay billete combinado con la Torre, compruébalo en la web oficial. LUNES: Todo cerrado. Cola iglesia: 20-40 min (verano). Mejor hora: 9:00-10:30 cuando abre. Audio-guía: 3€ (recomendada, explica decoraciones manuelinas). Tiempo visita: iglesia 30 min, claustro 20-30 min.',
    type: 'visit',
