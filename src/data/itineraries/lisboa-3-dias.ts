...
export const lisboa3DiasSintraTimeline: TimelineStop[] = [
  // DÍA 1 - LISBOA CLÁSICO
  {
    ...
    tip: '🚶 RUTA: Catedral Sé → calles aleatorias hacia arriba → Mirador Santa Luzia. Distancia: 1.5 km (pero con escaleras se siente como 3). GRATIS: Todo. Lleva agua, las subidas cansan. Mejor calzado: zapatillas con buen agarre. A primera hora suele haber bastante menos gente que a media mañana.',
    type: 'visit',
  ...
  },
  {
    time: '15:30',
    day: 1,
    title: 'Elevador de Santa Justa — El ascensor de hierro de la Baixa',
    ...
    tip: '⚠️ Elevador: cerrado por mantenimiento. GRATIS: Ver la estructura desde abajo —es igual de impresionante. OJO: el miradouro de arriba figura también cerrado temporalmente; consulta el estado en CARRIS antes de ir. Las Escadas do Carmo, al lado, se suben gratis. La estructura se ve desde la calle a cualquier hora y no cuesta nada.',
    type: 'visit',
    image: 'https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=800',
  ...
  },
  {
    ...
    description: 'Desde el elevador, sube al Chiado —el barrio intelectual de Lisboa, muy asociado a la figura de Fernando Pessoa y a sus cafés. El Chiado es más elegante que la Baixa, más cultural, más local —aquí están las librerías centenarias (Livraria Bertrand, desde 1732, la más antigua del mundo), los teatros, las galerías de arte, y el Lisboa que se piensa a sí mismo. Entra a "A Brasileira" (Rua Garrett 120, abierto desde 1905) —el café más famoso de Lisboa. En la terraza verás la estatua de bronce de Pessoa sentado en una mesa como si todavía estuviera esperando a alguien. El interior conserva la decoración art déco original: espejos, azulejos, mesas de mármol, y un ambiente que parece congelado en el tiempo. Pide un café —es una parada turística, pero la experiencia lo vale— y siéntate en la terraza, junto a la estatua que lo recuerda. El Chiado es perfecto para pasear sin rumbo —descubrir tiendas de diseño portugués, librerías independientes, y cafés escondidos en calles laterales.',
    tip: '☕ A Brasileira: turístico pero icónico, foto obligatoria con la estatua de Pessoa. Librerías: Bertrand (desde 1732, la más antigua del mundo), Ler Devagar (diseño espectacular). GRATIS: Pasear Chiado, ver tiendas, arquitectura. Tiempo: 1h paseando tranquilo.',
    type: 'food',
  ...
  // DÍA 2 - BELÉM COMPLETO
  {
    ...
    tip: '🎫 Consulta el precio vigente en museusemonumentos.pt. HORARIO: 9:30-18:00, con última venta de billetes a las 17:00 y último acceso a las 17:30. CIERRA los lunes y el 1 de enero, Domingo de Pascua, 1 de mayo, 13 de junio y 25 de diciembre. Compra online para no depender de la taquilla. Escaleras MUY estrechas: no apto para claustrofobia ni movilidad reducida. En julio y agosto, llega a la apertura para ser de los primeros.',
    type: 'visit',
    image: 'https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=800',
  ...
  },
  {
    ...
    description: 'Ahora viene el momento que todos esperan: probar los pasteles de nata ORIGINALES en la pastelería que los inventó en 1837. Camina 5 minutos desde el monasterio hasta Pastéis de Belém - la fábrica azul y blanca con cola eterna en la tienda para llevar. PERO ESPERA. No hagas la cola. El truco maestro: entra directamente por las puertas que dicen "SALÃO" (salones). Son salas enormes con azulejos antiguos hasta el techo, meseros con pajarita negra y mesas de mármol, y casi siempre menos espera que en el mostrador de la calle. Siéntate, pide 2-3 pasteles por persona y un café, y espera 5 minutos. Cuando lleguen calentitos, espolvorea canela y azúcar glas (están en las mesas en dispensadores). La casa mantiene la receta en secreto y nunca la ha hecho pública. El hojaldre está crujiente como obleas, la crema quemada por arriba ligeramente caramelizada. Es ridículamente bueno. Vas a entender por qué se forma cola en la puerta.',
    tip: '🥐 TRUCO ORO: Evita cola tienda - entra DIRECTO a "Salão" (salones restaurante, señalizado). Pide mínimo 2 por persona. Canela + azúcar glas en las mesas. Consulta el horario en su web antes de ir. Para llevar, las cajas cerradas aguantan bien el resto del día.',
    type: 'food',
  ...
  },
  {
    ...
    description: 'Después del sugar rush de los pasteles, camina 10 minutos por el paseo marítimo hasta el MAAT (Museo de Arte, Arquitectura y Tecnología). El edificio por fuera ya es una obra de arte: estructura ondulante blanca de azulejos que parece una ola gigante saliendo del Tajo. El edificio tiene una rampa que sube hasta la cubierta, con vistas al río, al puente 25 de Abril y a Belém. Conviene comprobar en la web del museo las condiciones de acceso, que cambian según la programación. Muchos turistas no saben esto y pagan entrada solo para las exposiciones de dentro. Si te gusta arte contemporáneo/instalaciones/arquitectura moderna, la entrada vale la pena - exposiciones rotativas de artistas internacionales, instalaciones interactivas, y espacios de diseño brutalista. Si no eres muy de museos, la propia arquitectura del edificio y el paseo del río ya valen la parada ondulante, y sigue tu camino. El área alrededor tiene cafés modernos con terraza al río perfectos para descansar.',
    tip: '🎨 Consulta tarifas y condiciones de acceso en maat.pt: cambian según la programación. Entrada gratuita para menores de 12 años y, para residentes en Portugal, el primer domingo de cada mes de 10:00 a 13:00. HORARIO: de miércoles a lunes, 10:00-19:00. Martes cerrado. Tiempo visita: 1-1.5h. Cafetería en planta baja con terraza al Tajo.',
    type: 'visit',
  ...
  // DÍA 3 - SINTRA COMPLETO
  {
    ...
    description: 'Día 3 es tu excursión a Sintra —el pueblo de palacios de colores escondido en las montañas a cuarenta minutos de Lisboa que parece sacado de un cuento de hadas. Sal TEMPRANO. Esto es crítico y no es una exageración. Coge el tren desde la Estación Rossio (centro de Lisboa, fácil de llegar en metro línea verde) hacia Sintra —salen con frecuencia a lo largo del día. Compra billete de ida y vuelta en las máquinas automáticas de la estación (aceptan tarjeta y efectivo); la tarifa vigente está en la web de CP. El viaje atraviesa suburbios lisboetas, campos verdes, y finalmente montañas cubiertas de bosque hasta llegar al pueblo de Sintra, que aparece como una visión entre la neblina. Cuando bajes del tren, NO camines al centro todavía —ese es el error que cometen todos y que te hará perder tiempo. Ve DIRECTO a los autobuses que están junto a la estación: el 434 (circular que sube al Palacio da Pena y al Castelo dos Mouros) o el 435 (va a Quinta da Regaleira). Cómpralos en el kiosco junto a la estación antes de que se forme cola. La clave de Sintra es simple: llega temprano (antes de las 9:00) y usa los buses: a partir de media mañana las colas de los palacios se alargan mucho. Sintra es una fantasía completa —neblina frecuente en las montañas que añade misterio, palacios de colores imposibles que parecen de Disney, jardines laberínticos con túneles secretos, bosques encantados con árboles exóticos traídos de todo el mundo, y una atmósfera que Lord Byron describió como "el paraíso en la tierra". Vas a sentir que entraste a un cuento de hadas, y no es una metáfora —es exactamente así.',
    tip: '🚂 TREN: Estación Rossio (Lisboa) → Sintra, línea de Sintra de los Comboios Urbanos. Consulta horarios, frecuencia y tarifa vigente en cp.pt antes de salir: cambian, y el precio depende del título que uses. BUSES Sintra: el 434 sube a Pena y Mouros y el 435 va a Regaleira; consulta su tarifa vigente antes de viajar. CRÍTICO: Sal de Lisboa antes de las 8:30 para llegar a Sintra antes de las 9:30. A partir de las 10:00 coinciden los grupos de cruceros y los tours organizados. Compra las entradas a los palacios online por adelantado: en Pena, además, el acceso al interior es con hora reservada.',
    type: 'visit',
  ...
  },
  {
    ...
    tip: '🎫 Hay tarifa de adulto, joven, sénior y billete familiar; consulta los importes vigentes en parquesdesintra.pt. La taquilla cierra entre las 12:00 y las 13:00, y no se puede subir en coche particular. Tiempo de visita: 1h. FÍSICO: Muchas escaleras, subidas empinadas, zonas sin barandilla. Lleva agua. Mejor CON neblina (ambiente épico) o día claro (vistas infinitas). Calzado trekking recomendado - piedras resbaladizas.',
    type: 'visit',
