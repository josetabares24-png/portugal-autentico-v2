...
export const lisboa2DiasDia1Timeline: TimelineStop[] = [
  {
    time: '09:00',
    title: 'Baixa Pombalina y Chiado — El corazón histórico de Lisboa',
    /*
     * El texto anterior encadenaba cuatro afirmaciones que no podemos sostener:
     * dos metáforas de centralidad, una sobre reconstruir la ciudad partiendo
     * de nada, y un superlativo que hacía de la Baixa la primera planificación
     * urbana moderna del continente. Ese último es además falso; los otros tres
     * son retórica sin fuente. Se sustituyen por lo que sí está documentado: el
     * terremoto, el plan y lo que hoy se ve en la calle.
     *
     * También trataba el Chiado como parte de la Baixa Pombalina. No lo es: son
     * dos barrios distintos y el recorrido pasa de uno al otro. Ahora la
     * transición lo dice.
     */
    description: 'Empezamos en la Baixa Pombalina, el sector del centro reconstruido tras el terremoto de 1755 según el plan impulsado durante el gobierno del Marqués de Pombal. Sus calles rectas, las manzanas regulares y la uniformidad de sus fachadas todavía muestran la lógica de aquella reconstrucción. Empieza en Praça do Comércio, una plaza abierta directamente al río, donde estuvo el palacio real antes del terremoto y donde atracaban los barcos del comercio marítimo portugués. Las arcadas que la rodean han visto desfiles, revoluciones y ahora turistas haciendo fotos. Camina por Rua Augusta, la calle peatonal principal, llena de tiendas, artistas callejeros y el bullicio de una capital viva, hasta Rossio, que ha sido plaza de encuentro de Lisboa durante siglos. Desde Rossio, el recorrido continúa hacia Carmo y Chiado. Pasa por el Elevador de Santa Justa, un ascensor de hierro neogótico de 1902 diseñado por Raoul Mesnier du Ponsard. Actualmente está cerrado (2026) por mantenimiento, pero la estructura sigue siendo impresionante desde abajo. El miradouro de arriba también figura cerrado temporalmente, así que consulta el estado del elevador y del mirador en CARRIS antes de organizar la visita. Mientras tanto, las Escadas do Carmo se suben gratis y desde el Largo do Carmo hay vistas de la Baixa sin pagar nada. Ya en Chiado —barrio distinto de la Baixa, con otra historia y otro carácter— estás en la zona de cafés, librerías y teatros donde Pessoa pasaba las mañanas. Entra a "A Brasileira" (abierto desde 1905) y verás la estatua de Pessoa sentado en la terraza como si todavía estuviera esperando a alguien. El Chiado es más elegante y más cultural que la Baixa: aquí están las librerías centenarias, los teatros y las galerías de arte.',
    tip: '⚠️ Elevador Santa Justa: Actualmente CERRADO (2026) por mantenimiento. La estructura sigue siendo impresionante desde abajo (gratis) —vale la pena verla aunque no puedas subir. OJO: el miradouro de arriba también figura cerrado temporalmente. Consulta el estado del elevador y del mirador en CARRIS antes de organizar la visita. Las Escadas do Carmo se suben gratis y llevan al Largo do Carmo. A Brasileira: café 2-4€ (turístico pero icónico, vale la foto). Las librerías del Chiado son preciosas —Bertrand (desde 1732, la más antigua del mundo) y Ler Devagar (diseño espectacular) merecen una visita.',
    type: 'visit',
  ...
  },
  {
    ...
    tip: '🚋 Billete: 3,30€ comprándolo a bordo, y ahí aceptan tarjeta y contactless además de efectivo. Sale mucho mejor con la tarjeta Navegante ocasional (0,50€ la tarjeta): el billete CARRIS/Metro está en 1,90€ y el zapping en 1,72€. MEJOR HORARIO: 9:00-11:00 o después de las 18:00 (menos turistas, más espacio). Evita 12:00-17:00 que va REPLETO de grupos organizados y es imposible disfrutarlo. Si quieres ir sentado, sube en Martim Moniz (inicio) o Campo de Ourique (final) —las paradas intermedias suelen estar llenas. El recorrido completo dura 40-45 minutos y es una de las mejores formas de ver Lisboa sin caminar.',
    type: 'visit',
...
export const lisboa2DiasDia2Timeline: TimelineStop[] = [
  ...
  },
  {
    ...
    tip: '🥐 ESTRATEGIA PRO: Ignora completamente la cola de la entrada (para llevar). Entra directo al salón gigante de atrás señalizado como "Salão" → casi nunca hay cola, te sientas en mesas de mármol, comes caliente recién horneado, y la experiencia es mucho mejor. Precio: 1,60€/unidad y 9,60€ la caja de 6. Pide "3 pastéis quentes, um galão" y siéntate. El salón de atrás tiene 400 asientos —siempre hay sitio. Abre 8:00-23:00 todos los días. Si quieres llevar a casa, pide caja de 6 o 12 —aguantan bien unas horas pero pierden el crujiente al día siguiente.',
    type: 'food',
...
// Timeline stops para Lisboa 2 días - Combinado
export const lisboa2DiasTimeline: TimelineStop[] = [
  ...
  },
  {
    ...
    tip: '🚋 Ticket: 3,30€ a bordo, con tarjeta o en efectivo. Con la tarjeta Navegante ocasional sale más barato: 1,90€ el billete CARRIS/Metro o 1,72€ en zapping. EVITA: 11:00-16:00 (repleto de turistas). MEJOR: 9:00-10:30 o 17:00-19:00. Parada inicial Martim Moniz para ir sentado. Recorrido completo: 45 min.',
    type: 'visit',
    image: 'https://images.unsplash.com/photo-1597426509446-cd65442af149?w=800',
  ...
  },
  {
    ...
    description: 'Bájate del 28 en la Baixa Pombalina, el sector del centro reconstruido tras el terremoto de 1755. Camina por Rua Augusta (calle peatonal principal) hasta la Praça do Comércio - plaza enorme con arcadas amarillas abierta al río Tajo. Desde aquí, sube al Arco da Rua Augusta (5€, mirador 360°) para vistas de toda Baixa y el río. Después camina hasta el Elevador de Santa Justa - ascensor neogótico de hierro de 1902 que parece sacado de París. Actualmente está cerrado (2026) por mantenimiento, pero vale la pena verlo desde abajo —la estructura en sí es una obra de arte arquitectónica. El miradouro de arriba también figura cerrado temporalmente: consulta el estado en CARRIS antes de ir. Las Escadas do Carmo se suben gratis. Pasea por las calles de Baixa viendo las tiendas de azulejos, pastelerías con vitrinas de pasteles de nata, y la arquitectura pombalina reconstruida después del terremoto de 1755.',
    tip: '🏛️ Arco da Rua Augusta: 5€, vistas 360°. ⚠️ Elevador Santa Justa: CERRADO (2026). GRATIS: Caminar Baixa, Praça Comércio, fotos del elevador desde abajo. ALTERNATIVA: Escadas do Carmo, gratis. El miradouro de arriba figura cerrado temporalmente; consulta el estado en CARRIS. Pastelerías recomendadas: Confeitaria Nacional (desde 1829), pastel de nata 1.20€.',
    type: 'visit',
    image: 'https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=800',
    coordinates: { lat: 38.7071, lng: -9.1364 },
    googleMapsUrl: 'https://maps.google.com/?q=38.7071,-9.1364'
  ...
  // DÍA 2
  {
    ...
    tip: '🎫 Torre de Belém: 15€, de martes a domingo 9:30-17:30. Claustro de los Jerónimos: 18€, de martes a domingo 9:30-17:30, última entrada a las 17:00. La iglesia de los Jerónimos es GRATIS pero tiene su propio horario, distinto del claustro: de martes a sábado 10:30-17:00 y domingos y festivos religiosos 14:00-17:00. Los dos monumentos cierran los lunes. TRUCO: empieza por la Torre cuando abre y sigue por Jerónimos.',
    type: 'visit',
    image: 'https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=800',
    coordinates: { lat: 38.6916, lng: -9.2158 },
    googleMapsUrl: 'https://maps.google.com/?q=38.6916,-9.2158'
  },
  {
    ...
    description: 'Ahora viene EL MOMENTO. Camina 5 minutos hasta Pastéis de Belém - la pastelería original que inventó los pasteles de nata en 1837. Hay SIEMPRE cola en la tienda para llevar (30+ personas), pero el truco es entrar directamente a las SALAS DEL FONDO (señaladas como "Salão"). Son salones enormes con azulejos antiguos, meseros con pajarita, y mesas para sentarte. Aquí NO hay cola. Pide 2-3 pasteles por persona (1,60€ cada uno), un café, y espolvorea canela y azúcar glas encima (están en las mesas). La receta es secreta desde hace 200 años - solo 3 maestros pasteleros la conocen. El hojaldre crujiente + la crema caliente cremosa = explosión de sabor.',
    tip: '🥐 Precio: 1,60€/pastel y 9,60€ la caja de 6. TRUCO CLAVE: Evita cola - entra directo a "Salão" (salones del fondo). Pide mínimo 2 por persona. Canela + azúcar glas en las mesas. Abre 8:00-23:00 todos los días. Tronas disponibles, kid-friendly. Para llevar: pide caja de 6 o 12 (viajan bien).',
    type: 'food',
