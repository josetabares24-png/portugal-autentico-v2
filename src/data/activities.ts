...
export const activities: Activity[] = [
  ...
  },
  {
    ...
    experiencia: {
      ...
      queVeras: [
        'El Castelo de São Jorge y la colina del castillo',
        'La Baixa y el río Tajo',
      ...
      elError: 'Venderlo como un lugar siempre vacío. Visit Lisboa lo describe como tranquilo, pero la propia Câmara de Lisboa también lo presenta como uno de los miradores más emblemáticos y buscados.',
      comoLlegar: 'Está en Largo do Monte, en Graça. Conviene comprobar el transporte del día antes de subir porque las líneas y paradas pueden cambiar.',
    },
    indexable: true,
    ...
    description: 'Mirador gratuito en Graça con una panorámica amplia del castillo, la Baixa y el Tajo.',
    savingTip: 'Si ya estás recorriendo Graça, encájalo en el mismo paseo en vez de subir solo para hacer una foto.',
  ...
  },
  {
    ...
    experiencia: {
      ...
      queVeras: [
        'La estructura metálica del elevador en plena Baixa',
        'El entorno del Largo do Carmo en la parte alta',
        'Las ruinas del Convento do Carmo a pocos pasos',
      ],
      cuandoIr: 'No organices una visita alrededor de la subida en cabina sin comprobar antes el estado del servicio en CARRIS.',
      elError: 'Usar información antigua de reapertura como si describiera el estado actual. CARRIS publica actualmente el mirador como temporalmente cerrado y mantiene un proceso específico de evaluación de estos equipos históricos.',
      comoLlegar: 'Está entre la Rua do Ouro, en la Baixa, y el Largo do Carmo. Aunque la cabina o el mirador estén cerrados, la zona puede recorrerse a pie por Chiado y Carmo.',
    },
    indexable: true,
    ...
    zone: 'Baixa / Carmo',
    isFree: false,
    priceLabel: 'Comprueba el estado antes de ir',
    duration: '15-30 min en la zona',
    ...
    description: 'Elevador histórico entre la Baixa y Carmo; comprueba su estado actual antes de planificar una subida.',
    savingTip: 'Si el elevador o el mirador están cerrados, puedes llegar a la zona alta caminando desde Chiado y visitar el entorno del Carmo sin depender de la cabina.',
    officialUrl: 'https://www.carris.pt/viaje/alteracoes-de-servico/elevador-sta-justa-miradouro-encerrado/',
    lastVerified: '2026-09-23',
    statusNote: 'CARRIS publica actualmente el Miradouro do Elevador de Santa Justa como temporalmente cerrado. El plan 2026 de CARRIS también recoge el proceso técnico para validar la reapertura del elevador y otros equipos históricos. Comprueba el estado el mismo día.',
  },
  {
    ...
    experiencia: {
      ...
      queVeras: [
        'El gran acuario central con distintas especies marinas',
        'Hábitats que representan diferentes ambientes oceánicos',
        'Nutrias, aves marinas y otras especies a lo largo del recorrido',
      ],
      cuandoIr: 'El Oceanário abre todos los días de 10:00 a 20:00 y la última entrada es a las 19:00. Los precios varían según la franja horaria.',
      elError: 'Dar por hecho que todas las horas cuestan lo mismo. La tarifa de adulto publicada para 2026 cambia según la franja y la más económica es la última parte de la tarde.',
      comoLlegar: 'Metro línea roja hasta Oriente. El Oceanário está en la Doca dos Olivais, dentro de Parque das Nações.',
    },
    indexable: true,
    ...
    description: 'Acuario en Parque das Nações con precios variables según la franja horaria y una visita media de 1,5 a 2 horas.',
    savingTip: 'La web oficial anuncia un 5 % de descuento para compra online y precios distintos según la hora. Compara franjas antes de elegir.',
  ...
  },
  {
    ...
    experiencia: {
      ...
      queVeras: [
        'El centro de Cascais y su paseo marítimo',
        'La Boca do Inferno, al oeste del centro',
        'El Cabo da Roca y sus acantilados frente al Atlántico',
        'Playas y tramos de costa entre Cascais y Sintra',
      ],
      cuandoIr: 'Reserva medio día largo o un día completo si quieres combinar Cascais y Cabo da Roca sin ir con prisa. El viento y la niebla pueden cambiar bastante la experiencia en el cabo.',
      elError: 'Usar información antigua de Scotturb. El transporte metropolitano cambió y Carris Metropolitana publica actualmente líneas como la 1624 en el entorno de Cabo da Roca.',
      comoLlegar: 'Visit Cascais indica tren de la línea de Cascais desde Cais do Sodré. Para Cabo da Roca, comprueba el horario actual en Carris Metropolitana; la parada de Estrada do Cabo da Roca sirve líneas como 1253 y 1624.',
    },
    indexable: true,
    ...
    zone: 'Cascais / Sintra',
    isFree: false,
    priceLabel: 'Transporte público: consulta tarifas actuales',
    duration: 'Medio día largo / día completo',
    image: '/images/actividades/cascais-centro-historico.webp',
    imageAlt: 'Centro histórico de Cascais con su calçada portuguesa',
    description: 'Excursión por Cascais y Cabo da Roca combinando tren desde Lisboa y autobús hacia la costa de Sintra.',
    savingTip: 'No necesitas un tour para llegar, pero sí conviene revisar el horario del autobús al Cabo da Roca antes de organizar el resto del día.',
    officialUrl: 'https://carrismetropolitana.pt/stops/171949',
    lastVerified: '2026-09-23',
  },
  {
    slug: 'fado-en-alfama',
    experiencia: {
      ...
      queVeras: [
        'Una voz acompañada normalmente por guitarra portuguesa y viola',
        'Casas de fado pequeñas y restaurantes con programación en vivo',
        'En Alfama, el Museu do Fado ayuda a entender la historia del género antes de elegir una actuación',
      ],
      cuandoIr: 'No existe una hora universal para todas las casas de fado. Revisa la programación y las condiciones de reserva del local concreto antes de ir.',
      elError: 'Elegir únicamente por un cartel que promete una experiencia "auténtica". Compara qué incluye la reserva, si hay consumo mínimo, cuánto dura la actuación y qué artistas están programados.',
      comoLlegar: 'El Museu do Fado está en Largo do Chafariz de Dentro, en Alfama. La zona se recorre a pie desde Santa Apolónia y la Baixa.',
    },
    indexable: true,
    ...
    zone: 'Alfama',
    isFree: false,
    priceLabel: 'Variable según la casa y la reserva',
    duration: 'Variable',
    image: '/images/fado-tasca-noche.jpg',
    description: 'Fado en vivo en Alfama: qué comprobar antes de reservar y dónde entender mejor la historia del género.',
    savingTip: 'Antes de pagar un espectáculo, revisa si el precio incluye cena, consumo mínimo o solo la actuación. No todas las casas venden el mismo tipo de experiencia.',
  ...
  },
  {
    ...
    experiencia: {
      ...
      queVeras: [
        'La vista frontal de Lisboa desde Almada',
        'El puente 25 de Abril sobre el Tajo',
        'La terraza panorámica junto al monumento',
        'El propio santuario y la capilla',
      ],
      cuandoIr: 'Si quieres subir al monumento, mira antes el horario: de abril a septiembre abre de 10:00 a 19:00 y de octubre a marzo de 10:00 a 18:00. La última subida es 20 minutos antes del cierre.',
      elError: 'Dar por hecho que la entrada para subir se compra online. La web oficial indica que los billetes para la Capela dos Confidentes y la terraza del monumento se venden presencialmente.',
      comoLlegar: 'Desde Cacilhas, la web oficial indica la línea 3001 de Carris Metropolitana hasta el Santuário de Cristo Rei. También señala Pragal como la estación de tren más cercana.',
    },
    indexable: true,
    ...
    zone: 'Almada',
    isFree: false,
    priceLabel: 'Consulta el precio actualizado de la subida',
    duration: '1.5 h',
    image: '/images/actividades/cristo-rei-ponte-25-abril.webp',
    imageAlt: 'Cristo Rei y el puente 25 de Abril sobre el Tajo',
    description: 'Santuário en Almada con una terraza panorámica frente a Lisboa, el Tajo y el puente 25 de Abril.',
    savingTip: 'Si ya estás en Lisboa, combinar el ferry hasta Cacilhas con el autobús 3001 permite convertir el desplazamiento en parte del plan sin contratar un tour.',
    officialUrl: 'https://cristorei.pt/contacto/',
    lastVerified: '2026-09-23',
  },
];
