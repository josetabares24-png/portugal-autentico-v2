...
const articles: Record<string, Article> = {
  ...
  "mejores-miradores-lisboa": {
    ...
    contenido: [
      ...
      { tipo: "parrafo", texto: "La entrada general cuesta 17 euros, con tarifas reducidas para jóvenes y mayores de 65 años y entrada gratuita para menores de 13. A cambio, las murallas ofrecen la panorámica más completa de Lisboa. Desde aquí se entiende la geografía de la ciudad: cómo las colinas descienden hacia el río, cómo los barrios se conectan entre sí, cómo la luz cambia según la hora." },
  ...
  "historia-de-lisboa": {
    ...
    imageAlt: "Edificios de la Baixa Pombalina en Lisboa, reconstruida tras el terremoto de 1755",
    categoria: "Cultura",
    fecha: "20 Mar 2026",
    minutos: 18,
    contenido: [
  ...
  "terremoto-lisboa-1755": {
    ...
    imageAlt: "Fachadas de azulejos en la Baixa Pombalina, el barrio reconstruido tras el terremoto de 1755",
    categoria: "Cultura",
    fecha: "18 Mar 2026",
    minutos: 15,
    contenido: [
...
const localImages: Record<string, string> = {
  ...
  'historia-de-lisboa': '/images/lisboa-originales/esquina-baixa-pombalina-lisboa-02.webp',
  'terremoto-lisboa-1755': '/images/lisboa-originales/arquitetura-baixa-pombalina-lisboa-01.webp',
