...
const articles: Record<string, Article> = {
  ...
  "arquitectura-manuelina-lisboa": {
    ...
    metaDescription: "Qué es el estilo manuelino, cuáles son sus características y dónde verlo en Lisboa. Jerónimos, Torre de Belém, esfera armilar, Cruz de Cristo y claves para reconocerlo.",
    ...
    fuentes: [
      ...
      { label: "Visit Portugal — Patrimonio Mundial: Jerónimos y Torre de Belém", href: "https://www.visitportugal.com/pt-pt/content/patrimonio-mundial" },
    ],
    contenido: [
      ...
      { tipo: "lista", items: [
        ...
        "Base gótica tardía con influencias renacentistas: el manuelino no rompe completamente con el gótico, sino que lo transforma con un repertorio portugués propio.",
      ] },
      ...
      { tipo: "parrafo", texto: "La Torre de Belém es el otro gran referente lisboeta. Fue mandada construir por D. Manuel I y forma, junto con los Jerónimos, uno de los conjuntos más asociados internacionalmente al manuelino. Aquí el lenguaje ornamental se mezcla con la función defensiva de una torre situada en la entrada del estuario del Tajo." },
      ...
      { tipo: "parrafo", texto: "El manuelino no pertenece solo a Lisboa. Visit Portugal destaca también el Mosteiro da Batalha, el Convento de Cristo en Tomar, el Mosteiro de Jesus en Setúbal y ejemplos en Sintra. Esto importa porque ayuda a entender que no estamos ante una decoración inventada para Belém, sino ante un fenómeno artístico portugués de alcance nacional." },
      ...
      { tipo: "subtitulo", texto: "¿Por qué desapareció después?" },
      { tipo: "parrafo", texto: "El manuelino está muy ligado a un periodo concreto y al reinado de D. Manuel I. Con el avance del siglo XVI, el Renacimiento fue ganando peso y el lenguaje arquitectónico cambió. Por eso el estilo se reconoce hoy como una expresión especialmente concentrada en una etapa de la historia portuguesa." },
