...
const articles: Record<string, Article> = {
  ...
  'baixa-lisboa-que-ver': {
    ...
    categoria: 'Guías',
    fecha: '21 Sep 2026',
    fechaActualizacion: 'Actualizado el 23 de septiembre de 2026',
  ...
  'mejores-apps-lisboa': {
    ...
    descripcion: 'Aplicaciones útiles para viajar por Lisboa: transporte público, mapas, pagos y reservas, con especial atención a las apps que realmente ayudan a moverse.',
    seoTitle: 'Mejores apps para Lisboa: transporte, mapas y pagos',
    metaDescription: 'Mejores apps para Lisboa: Citymapper, mapas, transporte público, pagos y reservas. Qué instalar antes del viaje y qué aplicaciones puedes ahorrarte.',
  ...
  'lisboa-card-vale-la-pena': {
    ...
    descripcion: 'Cómo decidir si la Lisboa Card compensa en 2026 según los monumentos que visitarás, el transporte y el ritmo real de tu viaje.',
    seoTitle: 'Lisboa Card 2026: qué incluye y si vale la pena',
    metaDescription: '¿Vale la pena la Lisboa Card en 2026? Qué incluye, cómo encaja con el transporte y qué revisar antes de comprarla según tu itinerario.',
    imagen: '/images/funicular-bica-turistas.jpg',
  ...
  "donde-comer-barato-lisboa": {
    ...
    seoTitle: "Dónde comer barato en Lisboa: tascas y restaurantes",
    metaDescription: "Dónde comer barato en Lisboa: tascas y menús de almuerzo con precios publicados en 2026, mercados y cómo comprobar la carta antes de sentarte.",
    descripcion: "Opciones económicas para comer en Lisboa con ejemplos revisados en 2026, precios fechados y una forma práctica de elegir según la zona donde estés.",
    imagen: "/images/tasca-da-graca.jpg",
    imageAlt: "Tasca de barrio en Lisboa con mesas en la calle",
    categoria: "Gastronomía",
    fecha: "8 Feb 2026",
    fechaActualizacion: "Actualizado en septiembre de 2026",
    dateModified: "2026-09-23",
    minutos: 9,
    fuentes: [
      { label: "ASAE — precios en establecimientos de restauración", href: "https://www.asae.gov.pt/perguntas-frequentes1/area-economica/precos/precos-em-servicos-de-restauracao.aspx" },
      { label: "Tasca do Tretas — web oficial y horario", href: "https://tasca-do-tretas.eatbu.com/?lang=pt" },
      { label: "Lisboa Secreta — restaurantes con platos hasta 10 € (10 feb 2026)", href: "https://lisboasecreta.co/restaurantes-pratos-ate-10-euros/" },
      { label: "NiT — Maçã Verde y platos a 9,50 € (28 ago 2026)", href: "https://www.nit.pt/comida/restaurantes/a-tasca-de-lisboa-que-resiste-desde-1981-e-ainda-tem-pratos-a-850e" },
      { label: "NiT — Tasca do Carlos y especialidades hasta 10 € (11 jun 2026)", href: "https://www.nit.pt/comida/restaurantes/barata-e-honesta-na-tasca-do-carlos-e-o-proprio-que-faz-e-serve-os-bitoques-ha-decadas" },
      { label: "Mama Shelter Lisboa — menú actual de almuerzo", href: "https://pt.mamashelter.com/lisboa/eat-drink/restaurante-bar/" },
      { label: "Freguesia de Arroios — Mercado de Arroios", href: "https://jfarroios.pt/equipamentos/mercados/mercado-de-arroios/" },
    ],
    links: [
      { href: "/blog/presupuesto-viajar-lisboa", label: "Cuánto cuesta un viaje a Lisboa" },
      { href: "/blog/como-pagar-en-portugal", label: "Cómo pagar en Portugal" },
      { href: "/blog/time-out-market-lisboa", label: "Time Out Market: cómo funciona y si te conviene" },
      { href: "/blog/donde-tomar-cafe-lisboa", label: "Dónde tomar café en Lisboa" },
    ],
    contenido: [
      { tipo: "parrafo", texto: "Comer barato en Lisboa sigue siendo posible, pero no hay un precio único ni una lista que dure para siempre. Cambian los menús, cambian los platos del día y un sitio que hoy entra en una guía económica puede subir precios dentro de unos meses. Por eso aquí los precios llevan fecha y conviene comprobar la carta antes de ir." },
      { tipo: "parrafo", texto: "Para esta guía uso una referencia sencilla: opciones de almuerzo o platos principales alrededor de 15 € o menos. No es el precio medio de Lisboa ni una promesa de lo que gastarás; es solo un filtro práctico para separar opciones económicas de restaurantes donde la cuenta sube con facilidad." },

      { tipo: "subtitulo", texto: "Tasca do Tretas, en Alameda: menú sencillo y precios bajos" },
      { tipo: "parrafo", texto: "Tasca do Tretas está en Rua Carlos Mardel 115, cerca de Alameda. Su web oficial confirma que sirve cocina portuguesa y publica horario de 08:00 a 22:00. En febrero de 2026, Lisboa Secreta recogía menús semanales desde 7,50 €. Ese precio puede cambiar, así que úsalo como referencia fechada y mira la carta del día antes de pedir." },
      { tipo: "parrafo", texto: "Tiene más sentido si ya estás por Alameda, Arroios o Areeiro. Cruzar Lisboa solo para ahorrar unos euros puede dejar de compensar cuando sumas transporte y tiempo." },

      { tipo: "subtitulo", texto: "Maçã Verde, junto a Santa Apolónia: platos portugueses con precio publicado en 2026" },
      { tipo: "parrafo", texto: "Maçã Verde está en Rua dos Caminhos de Ferro, detrás de Santa Apolónia. Una revisión de NiT publicada el 28 de agosto de 2026 señalaba platos a 9,50 €. Es una referencia especialmente útil si vas a pasar por Santa Apolónia, São Vicente o la parte baja de Alfama." },
      { tipo: "parrafo", texto: "No tomaría los 9,50 € como precio garantizado para cualquier día: comprueba la carta cuando llegues. Lo importante aquí es que existe una opción reciente, documentada y cerca de una zona que muchos viajeros ya visitan." },

      { tipo: "subtitulo", texto: "Tasca do Carlos, en Graça: otra opción por debajo de 10 € publicada en 2026" },
      { tipo: "parrafo", texto: "En junio de 2026, NiT publicó que las especialidades de la Tasca do Carlos, en Graça, no superaban los 10 €. El local también puede aparecer en mapas por el nombre legal Rebelo & Afonso, así que conviene comprobar la ubicación antes de caminar hasta allí." },
      { tipo: "parrafo", texto: "Es una opción que encaja mejor si tu día ya pasa por Graça o sus miradores. La idea no es convertir una comida barata en una excursión aparte." },

      { tipo: "subtitulo", texto: "Mama Shelter: un menú de almuerzo con precio publicado por el propio restaurante" },
      { tipo: "parrafo", texto: "Si prefieres un precio fácil de verificar antes de salir, Mama Shelter publica actualmente un menú de día de 13,50 € de lunes a viernes al mediodía, excepto festivos, con plato, bebida y café. También publica una ensalada del día a 10 €. Está cerca de Marquês de Pombal y Avenida da Liberdade." },
      { tipo: "parrafo", texto: "No es una tasca tradicional ni pretende serlo. Lo incluyo porque resuelve otra necesidad: saber de antemano cuánto cuesta un almuerzo completo en una zona céntrica." },

      { tipo: "subtitulo", texto: "Mercado de Arroios: útil si quieres varias opciones en la misma zona" },
      { tipo: "parrafo", texto: "El Mercado de Arroios no garantiza por sí solo una comida barata, pero reúne snack-bar, cafetería y espacios de restauración además de los puestos tradicionales. La Junta de Freguesia publica horario de lunes a sábado, de 07:00 a 14:00, con cierre los domingos." },
      { tipo: "parrafo", texto: "Si ya estás por Arroios o Alameda, puede servir para mirar varias opciones sin reservar. Compara la carta de cada puesto: estar dentro de un mercado no significa automáticamente pagar menos." },

      { tipo: "subtitulo", texto: "Cómo encontrar un almuerzo barato sin depender de una lista" },
      { tipo: "lista", items: [
        "Mira si hay «prato do dia» o «menu do dia» y qué incluye exactamente.",
        "Compara el precio del plato con un menú que ya incluya bebida o café; a veces la diferencia final es pequeña.",
        "Comprueba primero tu zona. Ahorrar 3 € no sirve de mucho si tienes que hacer dos trayectos solo para comer.",
        "Lee la carta antes de sentarte si el presupuesto es importante para ti.",
        "Si el precio que ves en una guía tiene varios meses, tómalo como referencia y no como garantía."
      ]},

      { tipo: "subtitulo", texto: "Couvert y precios: qué pueden cobrarte" },
      { tipo: "parrafo", texto: "La ASAE indica que los restaurantes deben tener listas de precios en la entrada y en el interior, con los precios totales incluidos los impuestos. La lista también debe incluir el precio del couvert cuando exista." },
      { tipo: "parrafo", texto: "La misma norma aclara que un alimento o bebida, incluido el couvert, no puede cobrarse si no lo solicitaste ni lo consumiste. Si comes el pan, las aceitunas u otra entrada que dejan en la mesa, sí puede formar parte de la cuenta. Si no lo quieres, déjalo sin consumir y pide que lo retiren." },

      { tipo: "subtitulo", texto: "Qué opción elegir según dónde estés" },
      { tipo: "lista", items: [
        "Alameda o Arroios: compara Tasca do Tretas y las opciones del Mercado de Arroios.",
        "Santa Apolónia o São Vicente: Maçã Verde queda cerca de la estación.",
        "Graça: Tasca do Carlos puede encajar sin cambiar tu recorrido.",
        "Marquês de Pombal o Avenida: el menú publicado por Mama Shelter permite saber el coste antes de llegar.",
        "Otra zona: busca primero «prato do dia» cerca de ti antes de atravesar la ciudad por una recomendación."
      ]},

      { tipo: "subtitulo", texto: "Una última comprobación antes de ir" },
      { tipo: "parrafo", texto: "Los precios citados en esta guía fueron comprobados en fuentes publicadas durante 2026. Algunos son precios informados por el propio restaurante y otros proceden de publicaciones recientes sobre restauración en Lisboa. Si un sitio te interesa por el precio, revisa su carta o confirma el valor el mismo día." },
      { tipo: "enlace", texto: "Si lo que quieres es calcular cuánto reservar para comida durante todo el viaje, esta guía separa comida, alojamiento, transporte y entradas.", href: "/blog/presupuesto-viajar-lisboa", label: "Presupuesto para viajar a Lisboa" },
    ],
  },
  ...
  "mejor-epoca-visitar-lisboa": {
    ...
    seoTitle: "Mejor época para visitar Lisboa: clima y meses",
    metaDescription: "Cuándo viajar a Lisboa según clima: temperaturas y lluvia oficiales de IPMA, meses más secos, primavera, verano, otoño e invierno.",
    descripcion: "No existe un único mejor mes para Lisboa. Esta guía usa las normales climáticas oficiales para elegir según calor, lluvia, playa, caminatas y eventos.",
    imagen: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1200",
    ...
    minutos: 9,
    links: [
      { href: "/blog/lisboa-cuando-llueve", label: "Qué hacer en Lisboa cuando llueve" },
      { href: "/blog/playas-cerca-lisboa", label: "Qué playa elegir cerca de Lisboa" },
      { href: "/blog/festivales-eventos-lisboa-2026", label: "Eventos y festivales en Lisboa" },
      { href: "/blog/como-moverse-por-lisboa", label: "Cómo moverse por Lisboa" },
    ],
    fuentes: [
      { label: "IPMA — Normal Climatológica Lisboa / Instituto Geofísico 1991-2020", href: "https://www.ipma.pt/bin/file.data/climate-normal/cn_91-20_LISBOA_GEOFISICO.pdf" },
      { label: "IPMA — Normais climatológicas 1991-2020", href: "https://www.ipma.pt/pt/oclima/normais.clima/1991-2020/" },
      { label: "Visit Lisboa — Festas de Lisboa", href: "https://www.visitlisboa.com/pt-pt/eventos/festas-de-lisboa-1" },
    ],
    contenido: [
      { tipo: "parrafo", texto: "No hay un único «mejor mes» para Lisboa. Si quieres caminar sin tanto calor, mayo y septiembre son dos compromisos razonables. Si priorizas playa y poca lluvia, julio y agosto son los meses más secos. Si aceptas más lluvia a cambio de temperaturas más frescas, el invierno sigue siendo perfectamente visitable, pero exige un plan B." },
      { tipo: "parrafo", texto: "La diferencia importante es separar clima de precio o cantidad de visitantes. El clima sí puede compararse con datos históricos; vuelos, hoteles y afluencia dependen de las fechas concretas y deben comprobarse cuando vayas a reservar. Esta guía no inventa un porcentaje fijo de ahorro por viajar en enero ni promete calles vacías." },

      { tipo: "subtitulo", texto: "Qué dicen los datos oficiales del clima de Lisboa" },
      { tipo: "parrafo", texto: "Las normales climatológicas 1991-2020 del IPMA para Lisboa muestran un patrón muy claro: verano seco y cálido, otoño e invierno bastante más lluviosos y primavera de transición. La máxima media diaria pasa de 15,1 °C en enero a 28,8 °C en agosto; en mayo es 23,1 °C y en septiembre 26,6 °C." },
      { tipo: "parrafo", texto: "La lluvia cambia todavía más. El IPMA registra una media mensual de solo 2,6 mm en julio y 5,4 mm en agosto, frente a 110,6 mm en octubre, 133,9 mm en noviembre y 108,5 mm en diciembre. Son promedios climáticos, no una previsión para tu viaje: una semana concreta puede comportarse de manera distinta." },

      { tipo: "subtitulo", texto: "Mayo y septiembre: el equilibrio más fácil para caminar" },
      { tipo: "parrafo", texto: "Si tu prioridad es recorrer barrios, miradores y Belém a pie, mayo y septiembre evitan los extremos más claros del calendario climático. En mayo la máxima media es 23,1 °C y la precipitación mensual media 57,8 mm; en septiembre son 26,6 °C y 38,6 mm." },
      { tipo: "parrafo", texto: "No llamaría a esos meses «temporada perfecta» porque el precio del alojamiento y la cantidad de gente no se deducen de una normal climática. Lo que sí puede decirse es que, históricamente, ofrecen temperaturas más moderadas que julio y agosto y bastante menos lluvia que octubre, noviembre o diciembre." },

      { tipo: "subtitulo", texto: "Junio: clima seco y una Lisboa distinta por las fiestas" },
      { tipo: "parrafo", texto: "Junio ya entra en el tramo seco: el IPMA registra 14,1 mm de precipitación media mensual y una máxima media diaria de 26,1 °C. Además, las Festas de Lisboa ocupan buena parte del mes con arraiais, música, sardinas y celebraciones de Santo António en barrios como Alfama, Bica, Bairro Alto, Castelo y Mouraria." },
      { tipo: "parrafo", texto: "Eso convierte junio en una elección con personalidad propia. Puede interesarte precisamente por el ambiente de calle; si lo que buscas es silencio y una rutina urbana normal, conviene saber que algunas noches y barrios funcionan de otra manera durante las fiestas. El programa exacto cambia cada año, así que compruébalo en Visit Lisboa cuando se acerque el viaje." },

      { tipo: "subtitulo", texto: "Julio y agosto: los más secos, pero también los más calurosos" },
      { tipo: "parrafo", texto: "Julio y agosto son la opción más previsible si tu prioridad es minimizar la lluvia. En las normales del IPMA, julio tiene 0,6 días al mes con al menos 1 mm de precipitación y agosto 1,1. Las máximas medias son 28,2 °C y 28,8 °C, respectivamente." },
      { tipo: "parrafo", texto: "Eso funciona bien para combinar Lisboa con costa, pero cambia cómo conviene organizar la ciudad: caminatas largas por Alfama o Graça son más cómodas temprano o al final de la tarde que en las horas centrales. Si la playa pesa mucho en la decisión, compara primero el acceso; no todas las playas cercanas requieren el mismo tiempo de transporte." },
      { tipo: "enlace", texto: "Carcavelos, Caparica, Adraga y Arrábida resuelven días de playa muy distintos. Aquí están comparadas por logística.", href: "/blog/playas-cerca-lisboa", label: "Playas cerca de Lisboa" },

      { tipo: "subtitulo", texto: "Octubre y noviembre: baja la temperatura y sube claramente la lluvia" },
      { tipo: "parrafo", texto: "Octubre todavía tiene una máxima media agradable de 22,8 °C, pero la precipitación media mensual sube a 110,6 mm. Noviembre baja a 18,1 °C de máxima media y es el mes más lluvioso de la normal utilizada, con 133,9 mm." },
      { tipo: "parrafo", texto: "Eso no convierte el otoño en una mala época. Sí significa que un itinerario basado únicamente en miradores, terrazas y caminatas necesita alternativas cubiertas. Oceanário, museos, mercados y cafés funcionan mejor como plan B que intentar mantener una ruta exterior bajo lluvia fuerte." },
      { tipo: "enlace", texto: "Si el pronóstico cambia cuando ya estás en Lisboa, esta guía reorganiza el día sin perderlo.", href: "/blog/lisboa-cuando-llueve", label: "Qué hacer en Lisboa cuando llueve" },

      { tipo: "subtitulo", texto: "Diciembre, enero y febrero: invierno suave no significa invierno seco" },
      { tipo: "parrafo", texto: "En enero, la máxima media diaria es 15,1 °C y la mínima media 8,6 °C; en febrero, 16,4 °C y 9,1 °C. Son cifras mucho más suaves que las de muchas ciudades europeas, pero la lluvia es parte real del invierno: enero promedia 103,8 mm y unos 10 días con al menos 1 mm de precipitación." },
      { tipo: "parrafo", texto: "Por eso no prometería «chaparrones de veinte minutos» ni sol inmediato después de cada lluvia. Lleva una capa impermeable y calzado que agarre bien: la calçada portuguesa mojada puede ser incómoda, especialmente en pendientes." },
      ...
      { tipo: "lista", items: [
        "Quiero caminar mucho sin el calor medio de julio/agosto: mayo o septiembre.",
        "Quiero minimizar la lluvia y combinar ciudad con playa: julio o agosto.",
        "Quiero vivir las Festas de Lisboa: junio, comprobando el programa anual.",
        "No me molesta la lluvia y prefiero temperaturas frescas: diciembre, enero o febrero.",
        "Quiero primavera y puedo adaptar algún día al tiempo: marzo o abril.",
        "Quiero otoño: septiembre es climáticamente más seco; octubre y noviembre exigen más plan B.",
      ] },

      { tipo: "subtitulo", texto: "Clima no es lo mismo que previsión" },
      { tipo: "parrafo", texto: "Las normales del IPMA describen cómo se comportó el clima durante décadas; no dicen si va a llover el martes de tu viaje. Úsalas para escoger mes. Cuando falten pocos días, cambia de herramienta y mira una previsión meteorológica actual." },
      { tipo: "parrafo", texto: "Tampoco usaría esta página para afirmar qué mes es siempre más barato. Cuando tengas fechas posibles, compara vuelos y alojamiento para esas fechas concretas. El mejor momento para viajar es el que encaja con lo que quieres hacer y con el precio que realmente encuentres, no con una cifra genérica de una guía." },
    ],
  },
    "que-ver-cascais-desde-lisboa": {
    titulo: "Cascais desde Lisboa: qué ver y cómo organizar el día",
    seoTitle: "Cascais desde Lisboa: qué ver y cómo ir",
    metaDescription: "Qué ver en Cascais desde Lisboa: tren, centro, Boca do Inferno, museos, playa y una ruta realista para organizar un día.",
    descripcion: "Cómo decidir si Cascais merece un día de tu viaje, cómo llegar desde Lisboa y qué combinar sin convertir la excursión en una carrera.",
    ...
    fuentes: [
      { label: "Visit Cascais — información para visitantes", href: "https://www.visitcascais.com/en/visitor-information" },
      { label: "CP — alteraciones actuales en la Linha de Cascais", href: "https://cp.pt/info/pt/w/linha-de-cascais-servico-rodoviario" },
      { label: "Visit Cascais — Boca do Inferno", href: "https://www.visitcascais.com/en/partners/boca-do-inferno" },
      { label: "Visit Cascais — Casa das Histórias Paula Rego", href: "https://www.visitcascais.com/en/partners/casa-das-historias-paula-rego" },
      { label: "Visit Cascais — Museu Condes de Castro Guimarães", href: "https://www.visitcascais.com/en/partners/museu-condes-de-castro-guimaraes" },
    ],
    contenido: [
      { tipo: "parrafo", texto: "Cascais merece la excursión cuando quieres cambiar las colinas de Lisboa por costa, paseo marítimo y un centro pequeño que se recorre sin demasiada logística. Para una primera visita de solo dos días no la pondría por delante de Lisboa; con cuatro o cinco días, encaja mucho mejor." },
      { tipo: "parrafo", texto: "La ventaja es que no necesitas construir el día alrededor de una lista larga de monumentos. Puedes combinar centro, mar y una sola visita cultural. El error habitual es añadir Cascais, Cabo da Roca y Sintra como si fueran tres paradas pequeñas: en el mapa parecen próximas, pero juntas convierten el día en transporte y reloj." },

      { tipo: "subtitulo", texto: "Cómo ir de Lisboa a Cascais ahora" },
      { tipo: "parrafo", texto: "La conexión habitual es la Linha de Cascais de CP desde Cais do Sodré. Visit Cascais calcula alrededor de 40 minutos en tren en condiciones normales. Antes de salir, comprueba CP: durante las obras de modernización hay franjas concretas con transbordo en autobús entre Caxias y Cascais." },
      { tipo: "parrafo", texto: "A 23 de septiembre de 2026, CP mantiene esos transbordos durante interrupciones totales desde las 21:50 en días laborables, desde las 20:50 los sábados y en determinadas franjas de los domingos. Fuera de esos periodos indica que los trenes circulan normalmente. Si tu plan es volver de noche, esta comprobación importa más que memorizar un horario de una guía." },
      { tipo: "enlace", texto: "Si todavía no tienes claro cómo encajar trenes, metro y desplazamientos urbanos durante el viaje, usa primero esta guía.", href: "/blog/como-moverse-por-lisboa", label: "Cómo moverse por Lisboa en 2026" },

      { tipo: "subtitulo", texto: "Empieza por el centro y decide después cuánto mar quieres" },
      { tipo: "parrafo", texto: "Desde la estación puedes entrar directamente al centro de Cascais y orientarte sin transporte adicional. La escala es parte del atractivo: plazas, calles comerciales y la bahía quedan lo bastante cerca como para caminar sin convertir la llegada en otro traslado." },
      { tipo: "parrafo", texto: "No hace falta marcar diez puntos. Usa el centro como primera parte del día y deja la segunda para una decisión: museo, paseo costero o playa. Esa elección cambia mucho más la experiencia que sumar otra iglesia o otro mirador a una lista." },

      { tipo: "subtitulo", texto: "Si quieres cultura: elige un museo, no tres" },
      { tipo: "parrafo", texto: "Casa das Histórias Paula Rego tiene sentido si te interesa arte contemporáneo portugués. El edificio fue diseñado por Eduardo Souto de Moura y el museo reúne obra de Paula Rego y Victor Willing, además de exposiciones temporales." },
      { tipo: "parrafo", texto: "El Museu Condes de Castro Guimarães ofrece otra lectura: una casa histórica junto al mar, con artes decorativas, mobiliario indoportugués, biblioteca y el entorno del Parque Marechal Carmona. No son dos versiones del mismo museo. Elige según si prefieres arte del siglo XX o una casa histórica y su colección." },

      { tipo: "subtitulo", texto: "Boca do Inferno: cuándo añadirla" },
      { tipo: "parrafo", texto: "Boca do Inferno es una formación rocosa abierta por la acción del Atlántico a pocos minutos del centro de Cascais. Visit Cascais señala que existe un paseo costero que la conecta con la zona central. Tiene sentido cuando quieres caminar junto al mar; tiene menos sentido si tu prioridad es pasar varias horas en la playa o entrar a museos." },
      { tipo: "parrafo", texto: "No necesitas convertirla en una excursión aparte. Funciona mejor como continuación del paseo después del centro y antes de regresar, siempre que el tiempo y el estado del mar acompañen." },

      { tipo: "subtitulo", texto: "¿Y la playa?" },
      { tipo: "parrafo", texto: "Cascais permite combinar visita y arena, pero si tu objetivo principal es un día completo de playa conviene comparar antes Carcavelos, Costa da Caparica o Arrábida. Elegir la costa por una foto suele producir desplazamientos innecesarios; elegirla por acceso y por el tipo de día que quieres funciona mejor." },
      { tipo: "enlace", texto: "Aquí comparo las opciones cercanas por acceso, esfuerzo y tipo de playa, sin tratarlas como un ranking absoluto.", href: "/blog/playas-cerca-lisboa", label: "Playas cerca de Lisboa: cuál elegir" },

      { tipo: "subtitulo", texto: "Una ruta realista para un día" },
      { tipo: "lista", items: [
        "Llega por la mañana y recorre primero el centro y la bahía.",
        "Elige una sola visita cultural: Casa das Histórias Paula Rego o Museu Condes de Castro Guimarães.",
        "Deja el paseo costero y Boca do Inferno para después, si todavía quieres caminar.",
        "Si prefieres playa, recorta el bloque cultural en vez de intentar hacerlo todo.",
        "Antes de volver a Lisboa, revisa CP si tu regreso cae en una franja nocturna afectada por las obras.",
      ] },

      { tipo: "subtitulo", texto: "Cascais o Sintra: no resuelven el mismo día" },
      { tipo: "parrafo", texto: "Sintra exige reservas, desnivel y decisiones sobre palacios. Cascais funciona con un ritmo mucho más flexible. Si solo tienes un día libre fuera de Lisboa, elige según lo que te falte en el viaje: patrimonio monumental y sierra en Sintra; costa, paseo y una jornada más abierta en Cascais." },
      { tipo: "enlace", texto: "Si estás comparando más escapadas, esta guía las organiza por tiempo y logística.", href: "/blog/excursiones-desde-lisboa", label: "Excursiones desde Lisboa" },
      { tipo: "enlace", texto: "Si prefieres resolver transporte y varias paradas costeras en una actividad organizada, revisa la opción comercial solo después de comparar el plan por libre.", href: "/actividades/cascais-cabo-da-roca", label: "Ver opción Cascais y Cabo da Roca" },
    ],
  },
  "playas-cerca-lisboa": {
    titulo: "Playas cerca de Lisboa: cuál elegir según tiempo y transporte",
    seoTitle: "Playas cerca de Lisboa: Carcavelos, Caparica y Arrábida",
    metaDescription: "Qué playa elegir cerca de Lisboa: Carcavelos, Costa da Caparica, Adraga y Arrábida comparadas por transporte, tiempo y tipo de día.",
    descripcion: "No todas las playas cercanas a Lisboa sirven para el mismo viaje. Esta guía compara acceso, esfuerzo y tipo de día para elegir sin perder horas en traslados.",
    ...
    links: [
      { href: "/blog/que-ver-cascais-desde-lisboa", label: "Cascais desde Lisboa" },
      { href: "/blog/como-moverse-por-lisboa", label: "Cómo moverse por Lisboa" },
      { href: "/blog/excursiones-desde-lisboa", label: "Excursiones desde Lisboa" },
    ],
    fuentes: [
      { label: "Visit Cascais — Praia de Carcavelos", href: "https://www.visitcascais.com/en/partners/carcavelos-beach" },
      { label: "Visit Portugal — playas urbanas de Costa da Caparica", href: "https://www.visitportugal.com/es/content/costa-de-caparica-praias-da-vila" },
      { label: "Carris Metropolitana — líneas hacia las playas de Almada", href: "https://backoffice.carrismetropolitana.pt/praias-area3/" },
      { label: "Visit Sintra — Praia da Adraga", href: "https://visitsintra.travel/pt/visitar/praias/praia-da-adraga" },
      { label: "Município de Setúbal — Arrábida Sem Carros 2026", href: "https://www.mun-setubal.pt/arrabida-sem-carros/" },
      { label: "Município de Setúbal — praias da Arrábida", href: "https://www.mun-setubal.pt/atividade-municipal/turismo/praias/" },
    ],
    contenido: [
      { tipo: "parrafo", texto: "La pregunta útil no es cuál es la playa más bonita cerca de Lisboa. Es cuál puedes disfrutar con el tiempo y el transporte que tienes. Carcavelos, Costa da Caparica, Adraga y Arrábida ofrecen días muy distintos, y la opción más fotogénica puede ser la peor si obliga a gastar media jornada en llegar y volver." },
      { tipo: "parrafo", texto: "Para elegir, usa tres criterios: cuánto traslado aceptas, si quieres servicios cerca y si la playa será el plan principal o solo una parte del día. Con eso se eliminan muchas dudas antes de mirar el pronóstico." },

      { tipo: "subtitulo", texto: "Carcavelos: la opción sencilla si no quieres complicar el transporte" },
      { tipo: "parrafo", texto: "Carcavelos está en la costa de Cascais y su principal ventaja es el acceso. Visit Cascais la describe como el arenal más grande de la costa de Estoril y destaca tanto su popularidad en verano como el surf y bodyboard durante los meses de más oleaje." },
      { tipo: "parrafo", texto: "Es una elección práctica para quien quiere playa sin convertir el desplazamiento en una excursión completa. Si tu prioridad es tener arena, restaurantes y servicios cerca, tiene más sentido que perseguir una cala remota solo por la fotografía." },

      { tipo: "subtitulo", texto: "Costa da Caparica: más opciones y más arenal" },
      { tipo: "parrafo", texto: "Costa da Caparica no es una sola playa. El frente de arena se prolonga durante kilómetros y las zonas próximas a la población concentran más servicios y transporte. Visit Portugal señala que las playas urbanas cuentan con vigilancia en temporada y están próximas a conexiones de transporte público." },
      { tipo: "parrafo", texto: "Carris Metropolitana mantiene conexiones entre Lisboa y Costa da Caparica y refuerza la red de playas en temporada. Las líneas pueden cambiar, así que usa su planificador el mismo día en vez de guardar una captura antigua. Esta opción encaja mejor si quieres pasar varias horas en la arena y tener margen para escoger entre zonas más concurridas o alejarte del centro de la localidad." },

      { tipo: "subtitulo", texto: "Praia da Adraga: paisaje primero, logística después" },
      { tipo: "parrafo", texto: "Adraga, en el litoral de Sintra, destaca por el arco de roca y un entorno mucho menos urbano. Visit Sintra la presenta como una playa de ambiente casi salvaje y apta también para pasear fuera de la época balnear." },
      { tipo: "parrafo", texto: "La contrapartida es el acceso. No la elegiría para una escapada improvisada desde el centro de Lisboa sin haber resuelto antes cómo llegar y volver. Tiene sentido cuando el paisaje pesa más que la comodidad o cuando ya estás moviéndote por la zona de Sintra." },

      { tipo: "subtitulo", texto: "Arrábida: gran paisaje, pero no es la playa fácil de Lisboa" },
      { tipo: "parrafo", texto: "Las playas de la Arrábida tienen un entorno natural muy distinto al de Carcavelos o Caparica, pero exigen más planificación. El municipio de Setúbal gestiona accesos, estacionamiento y transporte de forma especial durante la época balnear para proteger una zona con capacidad limitada." },
      { tipo: "parrafo", texto: "En 2026 el programa Arrábida Sem Carros estuvo activo del 4 de junio al 15 de septiembre y restringió el acceso de vehículos particulares en varios tramos, reforzando el transporte público. Esa fecha ya pasó, pero la lección para un artículo evergreen es importante: antes de ir en verano, comprueba siempre el plan de acceso del año vigente." },
      { tipo: "parrafo", texto: "Si tienes poco tiempo en Lisboa, Arrábida no debería elegirse solo porque la foto sea espectacular. Funciona mejor cuando estás dispuesto a dedicar el día al desplazamiento y al parque natural." },

      { tipo: "subtitulo", texto: "¿Y las playas del propio Cascais?" },
      { tipo: "parrafo", texto: "Si ya vas a visitar Cascais, combinar el centro con una playa urbana puede ser más eficiente que construir un segundo desplazamiento. Esa solución es especialmente útil cuando quieres mitad paseo y mitad mar, no un día entero tumbado en la arena." },
      { tipo: "enlace", texto: "Si quieres mezclar playa, centro y paseo costero, aquí tienes la ruta específica.", href: "/blog/que-ver-cascais-desde-lisboa", label: "Qué ver en Cascais desde Lisboa" },

      { tipo: "subtitulo", texto: "Qué elegir según tu día" },
      { tipo: "lista", items: [
        "Quiero la logística más sencilla: Carcavelos.",
        "Quiero muchas opciones de arena y pasar varias horas: Costa da Caparica.",
        "Quiero paisaje y tengo el transporte resuelto: Praia da Adraga.",
        "Quiero naturaleza y puedo dedicar el día completo: Arrábida.",
        "Quiero combinar visita y un rato de playa: Cascais.",
      ] },

      { tipo: "subtitulo", texto: "Tres comprobaciones antes de salir" },
      { tipo: "lista", items: [
        "Mira el estado del mar y las condiciones meteorológicas del día; la costa atlántica cambia mucho la experiencia.",
        "Comprueba el transporte de vuelta, no solo el de ida, sobre todo si vas a una zona con servicio estacional.",
        "En Arrábida, revisa las restricciones de acceso vigentes antes de salir en coche.",
      ] },
      { tipo: "parrafo", texto: "Una playa útil para tu viaje no tiene que ser la más famosa. Tiene que permitirte pasar más tiempo junto al mar que esperando conexiones." },
      { tipo: "enlace", texto: "Si todavía estás decidiendo cómo repartir los días fuera de Lisboa, compara estas opciones con Sintra, Cascais, Óbidos y otras escapadas.", href: "/blog/excursiones-desde-lisboa", label: "Excursiones desde Lisboa" },
    ],
  },
  ...
  "vida-nocturna-lisboa": {
    ...
    seoTitle: "Vida nocturna en Lisboa: Bairro Alto y Cais do Sodré",
    metaDescription: "Vida nocturna en Lisboa: dónde salir en Bairro Alto y Cais do Sodré, dónde escuchar fado y qué hacer de noche según el ambiente que buscas.",
    descripcion: "Bairro Alto, Cais do Sodré, fado y otros planes para salir de noche en Lisboa según el ambiente que busques.",
  ...
  "azulejos-portugueses-historia": {
    ...
    seoTitle: "Azulejos portugueses: historia y dónde verlos en Lisboa",
    descripcion: "Historia y significado de los azulejos portugueses, cómo cambiaron con los siglos y dónde ver ejemplos destacados en Lisboa.",
    imagen: "https://images.unsplash.com/photo-1548707309-dcebeab9ea9b?w=1200",
  ...
  "lisboa-vs-porto": {
    ...
    seoTitle: "Lisboa vs Porto: diferencias y cuál elegir",
    metaDescription: "Lisboa vs Porto: compara qué ver, ambiente, cuántos días, excursiones y tipo de viaje para decidir cuál visitar o si conviene combinar las dos.",
  ...
  "semana-santa-lisboa": {
    ...
    seoTitle: "Semana Santa en Lisboa 2027: fechas y qué esperar",
    metaDescription: "Semana Santa en Lisboa 2027: Domingo de Ramos 21 de marzo, Viernes Santo 26 y Pascua 28. Qué está confirmado y qué conviene revisar antes del viaje.",
    descripcion: "Fechas de Semana Santa 2027, qué cambia para quien visita Lisboa, la histórica Procissão dos Passos da Graça y cómo distinguir una tradición estable de un programa anual todavía no publicado.",
    imagen: "https://images.unsplash.com/photo-1548707309-dcebeab9ea9b?w=1200",
    ...
    fuentes: [
      { label: "Revelar Lisboa — Procissão do Senhor dos Passos da Graça", href: "https://revelar.lisboa.pt/en/tradition/processions/senhor-dos-passos-da-graca-stations-of-the-cross" },
      { label: "Câmara Municipal de Lisboa — Procissão dos Passos da Graça", href: "https://informacao.lisboa.pt/noticias/detalhe/procissao-secular-percorre-as-ruas-do-centro-historico" },
      { label: "Calendario litúrgico de Portugal 2027", href: "https://gcatholic.org/calendar/2027/PT-en" },
      { label: "ACM / Código do Trabalho — feriados obrigatórios", href: "https://www.acm.gov.pt/documents/10181/706970/5%2BHor%C3%A1rio%2Bde%2Btrabalho%2C%2BFaltas%2C%2BF%C3%A9rias%2C%2BFeriados%2C%2BForma%C3%A7%C3%A3o%2BProfissional.pdf/6aa55650-1d60-4f11-9808-cda5c6bc8a1f" },
      { label: "Visit Portugal — Páscoa em Portugal", href: "https://www.visitportugal.com/pt-pt/content/pascoa-em-portugal" },
      { label: "Visit Lisboa — Mercado da Páscoa 2026", href: "https://www.visitlisboa.com/pt-pt/eventos/mercado-da-pascoa" },
    ],
    contenido: [
      { tipo: "parrafo", texto: "Si vas a Lisboa en Semana Santa de 2027, las fechas que organizan el viaje son claras: Domingo de Ramos el 21 de marzo, Jueves Santo el 25, Viernes Santo el 26 y Domingo de Pascua el 28. Lo que no está cerrado con tanta antelación es el programa concreto de misas, procesiones y actividades de cada iglesia." },
      { tipo: "parrafo", texto: "A 23 de septiembre de 2026 no hay un programa oficial completo de Semana Santa 2027 publicado para Lisboa. Esta distinción importa: una tradición puede repetirse durante siglos y, aun así, la hora o incluso la organización de una edición concreta debe confirmarse cuando se acerque la fecha." },

      { tipo: "subtitulo", texto: "Fechas de Semana Santa 2027 en Lisboa" },
      { tipo: "lista", items: [
        "Domingo de Ramos: 21 de marzo de 2027.",
        "Jueves Santo: 25 de marzo de 2027.",
        "Viernes Santo: 26 de marzo de 2027.",
        "Sábado Santo: 27 de marzo de 2027.",
        "Domingo de Pascua: 28 de marzo de 2027.",
      ] },
      { tipo: "parrafo", texto: "Viernes Santo y Domingo de Pascua figuran entre los feriados obligatorios en Portugal. Para un viajero eso no significa que toda Lisboa cierre, pero sí que museos, monumentos, comercios y transporte pueden aplicar horarios distintos. Comprueba cada lugar concreto antes de construir un día de reservas alrededor de su horario habitual." },

      { tipo: "subtitulo", texto: "La procesión histórica que conviene no confundir con el Domingo de Ramos" },
      { tipo: "parrafo", texto: "La Procissão do Senhor dos Passos da Graça es una de las tradiciones religiosas históricas más importantes de Lisboa. Se celebra desde 1587 y su recorrido tradicional une la Igreja de São Roque, en Bairro Alto, con la Igreja da Graça, pasando por Chiado, Rossio y Martim Moniz y deteniéndose en siete «Passos»." },
      { tipo: "parrafo", texto: "Pero hay una corrección importante respecto a muchas guías: esta procesión está vinculada a la Cuaresma y la información municipal la sitúa tradicionalmente en el segundo domingo de Cuaresma. No debe presentarse automáticamente como una procesión del Domingo de Ramos. Si tu viaje empieza el 21 de marzo de 2027, no des por hecho que la verás: confirma la edición de 2027 con la organización o con la agenda municipal cuando se publique." },
      { tipo: "enlace", texto: "El recorrido termina en Graça; si vas a visitar el barrio aunque no coincidas con la procesión, aquí tienes una ruta práctica.", href: "/blog/graca-lisboa-que-ver", label: "Qué ver en Graça" },

      { tipo: "subtitulo", texto: "Entonces, ¿qué se puede planificar ya?" },
      { tipo: "parrafo", texto: "Puedes reservar el viaje alrededor de las fechas y dejar las ceremonias concretas como una capa que se añade después. Lisboa tiene iglesias históricas como la Sé, São Roque y Graça donde la dimensión religiosa del periodo es visible, pero los horarios litúrgicos de 2027 deben comprobarse en sus canales oficiales o en el Patriarcado cerca de la fecha." },
      { tipo: "parrafo", texto: "La forma más segura de organizar el día es no encadenar una entrada con hora fija inmediatamente después de una ceremonia o procesión. Si quieres asistir a un acto religioso, trátalo como el bloque principal de esa parte del día y deja margen para desplazamientos y posibles cortes de calles." },

      { tipo: "subtitulo", texto: "Qué cambia en la ciudad durante esos días" },
      { tipo: "parrafo", texto: "Semana Santa coincide con un periodo de vacaciones y desplazamientos familiares en Portugal. Viernes Santo es feriado y el domingo ya funciona con la lógica habitual de un domingo festivo. No asumiría horarios comerciales normales ni prometería que una atracción concreta abre: los calendarios cambian por institución." },
      { tipo: "parrafo", texto: "En 2026, por ejemplo, Visit Lisboa anunció un Mercado da Páscoa en Praça Luís de Camões entre finales de marzo y abril. Eso demuestra que pueden aparecer actividades estacionales en el centro, pero no es una razón para anunciar el mismo mercado en 2027 antes de que exista una edición confirmada." },

      { tipo: "subtitulo", texto: "Qué comer en Pascua sin inventar una tradición lisboeta exclusiva" },
      { tipo: "parrafo", texto: "El folar y las almendras cubiertas de azúcar o chocolate forman parte de la gastronomía pascual portuguesa. Visit Portugal recuerda además que la forma y preparación del folar cambian según la región e incluso según la familia. Es mejor presentarlo como una tradición portuguesa que atribuir a Lisboa una receta única que no existe." },
      { tipo: "parrafo", texto: "Durante esas semanas es normal encontrar productos de Pascua en pastelerías y comercios, pero no necesitas organizar el viaje alrededor de una lista fija de locales: comprueba qué tiene cada pastelería cuando estés allí." },

      { tipo: "subtitulo", texto: "Cómo organizar una visita de Semana Santa" },
      { tipo: "lista", items: [
        "Usa las fechas de 2027 para reservar alojamiento y transporte.",
        "A partir de febrero de 2027, vuelve a comprobar la agenda municipal y las iglesias que quieras visitar.",
        "No planifiques la Procissão dos Passos como si fuera necesariamente el Domingo de Ramos.",
        "Revisa horarios especiales de monumentos y museos para Viernes Santo y Domingo de Pascua.",
        "Si asistes a una ceremonia, recuerda que es un acto religioso antes que una atracción turística.",
      ] },
      { tipo: "parrafo", texto: "La ventaja de Lisboa en Semana Santa no es una agenda gigantesca de procesiones. Es poder combinar una ciudad que sigue funcionando como destino cultural con tradiciones religiosas que conservan lugares y recorridos concretos. La clave es separar lo histórico de lo que realmente está confirmado para el año de tu viaje." },
    ],
  },
  ...
  "arquitectura-manuelina-lisboa": {
    ...
    seoTitle: "Estilo manuelino en Portugal: características y ejemplos",
    metaDescription: "Qué es el estilo manuelino en Portugal, sus características y símbolos, y dónde verlo: Jerónimos, Torre de Belém, esfera armilar y Cruz de Cristo.",
    descripcion: "Qué es el estilo manuelino en Portugal, cuáles son sus características y cómo reconocerlo, con los Jerónimos y la Torre de Belém como ejemplos principales.",
