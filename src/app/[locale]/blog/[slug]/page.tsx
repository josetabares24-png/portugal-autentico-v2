...
const articles: Record<string, Article> = {
  ...
  "mejor-epoca-visitar-lisboa": {
    ...
    titulo: 'Cascais desde Lisboa: qué ver y cómo organizar una excursión de un día',
    descripcion: 'Cómo ir de Lisboa a Cascais en tren y qué ver en un día: centro histórico, playas, Boca do Inferno, museos y una ruta sin prisas.',
    seoTitle: 'Cascais desde Lisboa: qué ver y cómo ir',
    metaDescription: 'Qué ver en Cascais desde Lisboa: tren desde Cais do Sodré, centro, playas, Boca do Inferno y una ruta práctica para una excursión de un día.',
    imagen: '/images/actividades/cascais-centro-historico.webp',
    imageAlt: 'Letras de Cascais sobre la calçada portuguesa frente al ayuntamiento',
    categoria: 'Guías',
    fecha: '12 Ene 2026',
    fechaActualizacion: 'Actualizado en septiembre de 2026',
    dateModified: '2026-09-21',
    ...
    fuentes: [
      { label: 'Visit Cascais: información para visitantes', href: 'https://www.visitcascais.com/pt/visitor-information' },
      { label: 'Visit Cascais: Boca do Inferno', href: 'https://www.visitcascais.com/pt/partners/boca-do-inferno' },
      { label: 'CP: Linha de Cascais y alteraciones de servicio', href: 'https://www.cp.pt/info/w/linha-de-cascais-servico-rodoviario' },
    ],
    contenido: [
      { tipo: 'parrafo', texto: 'Cascais es una de las excursiones más fáciles desde Lisboa porque combina tren, centro histórico, paseo marítimo y playa sin necesitar coche. Para una primera visita, lo más útil es tratarlo como un día de costa y no como una lista de atracciones que haya que completar.' },

      { tipo: 'subtitulo', texto: 'Cómo ir de Lisboa a Cascais en tren' },
      { tipo: 'parrafo', texto: 'La Linha de Cascais sale de Cais do Sodré y termina en Cascais. Visit Cascais sitúa el trayecto en torno a 40 minutos. Antes de salir, consulta CP: la línea está sometida a trabajos de modernización y puede tener alteraciones o servicios de sustitución en determinados periodos.' },
      { tipo: 'parrafo', texto: 'No fijes tu itinerario alrededor de un supuesto tren “exprés” ni de una frecuencia guardada meses atrás. Mira el horario vigente para tu fecha y deja margen si tienes una reserva o una conexión posterior.' },

      { tipo: 'subtitulo', texto: 'Empieza por el centro histórico' },
      { tipo: 'parrafo', texto: 'La estación queda cerca del núcleo central, así que no necesitas otro transporte para empezar. La zona se recorre bien a pie y conecta con la bahía, calles comerciales, plazas y el frente marítimo.' },
      { tipo: 'parrafo', texto: 'No dedicaría la mañana a buscar una lista de tiendas o restaurantes “imprescindibles”. Recorre el centro, mira el paseo junto al mar y decide cuánto tiempo quieres reservar para playa, museos o Boca do Inferno.' },

      { tipo: 'subtitulo', texto: 'Playas en el propio Cascais' },
      { tipo: 'parrafo', texto: 'Una de las ventajas de Cascais es que puedes combinar el paseo con playas próximas al centro sin organizar un traslado aparte. Si el objetivo principal del día es bañarte, comprueba viento, estado del mar y condiciones de la playa antes de decidir dónde quedarte.' },
      { tipo: 'enlace', texto: 'Si buscas una jornada principalmente de playa y quieres comparar otras zonas de la costa, usa esta guía.', href: '/blog/playas-cerca-lisboa', label: 'Playas cerca de Lisboa' },

      { tipo: 'subtitulo', texto: 'Boca do Inferno' },
      { tipo: 'parrafo', texto: 'Boca do Inferno es una formación rocosa abierta al Atlántico y uno de los paseos naturales más conocidos de Cascais. Visit Cascais destaca sus miradores y el paseo costero que la conecta con el centro. El aspecto cambia mucho según el oleaje: con mar tranquilo es un mirador; con mar más fuerte se entiende mejor su nombre.' },
      { tipo: 'parrafo', texto: 'Puedes llegar caminando desde el centro si te apetece prolongar el paseo. No necesitas convertirlo en una visita con hora fija.' },

      { tipo: 'subtitulo', texto: 'Museos, parques y jardines' },
      { tipo: 'parrafo', texto: 'Cascais también tiene una concentración interesante de espacios culturales, parques y jardines. Si el día no está para playa, puedes dedicar más tiempo a esta parte y dejar la costa como paseo. Comprueba horarios y exposiciones del espacio concreto antes de organizar la jornada alrededor de él.' },

      { tipo: 'subtitulo', texto: 'Una ruta sencilla para un día' },
      { tipo: 'lista', items: [
        'Llegada en tren a Cascais y paseo por el centro histórico.',
        'Bahía y frente marítimo.',
        'Playa si el tiempo acompaña o museo/parque si prefieres una visita cubierta.',
        'Paseo hacia Boca do Inferno.',
        'Regreso al centro con margen antes del tren de vuelta.',
      ] },

      { tipo: 'subtitulo', texto: 'Cuánto tiempo dedicar' },
      { tipo: 'parrafo', texto: 'Una mañana permite conocer el centro y acercarte a la costa, pero un día completo da margen para caminar, comer sin prisa y añadir playa o cultura. Si Cascais es solo una parada rápida antes de otro destino, elimina cosas en lugar de acelerar el recorrido.' },

      { tipo: 'subtitulo', texto: '¿Cascais y Sintra el mismo día?' },
      { tipo: 'parrafo', texto: 'Es posible enlazar ambas zonas, pero para una primera visita no lo usaría como plan base. Sintra ya exige transporte interno y entradas con hora; sumar Cascais hace que cualquier retraso se propague durante toda la jornada. Si dispones de varios días, es más cómodo separarlos.' },
      { tipo: 'enlace', texto: 'Antes de intentar combinarlos, mira cuánto ocupa realmente una visita a Sintra.', href: '/blog/sintra-desde-lisboa', label: 'Sintra desde Lisboa' },

      { tipo: 'subtitulo', texto: 'Qué comprobar antes de salir' },
      { tipo: 'lista', items: [
        'Horario y alteraciones de la Linha de Cascais en CP.',
        'Previsión de viento y lluvia si tu prioridad es la costa.',
        'Horario del museo o espacio cultural que quieras visitar.',
        'Hora aproximada de regreso si después tienes una reserva en Lisboa.',
      ] },
    ],
  },  "playas-cerca-lisboa": {
