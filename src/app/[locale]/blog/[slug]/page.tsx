...
const articles: Record<string, Article> = {
  ...
  "historia-de-lisboa": {
    ...
    imageAlt: "Mural pintado a mano con viñetas de la historia de Lisboa, desde la conquista de 1147 hasta el Acueducto de las Aguas Libres, con la fecha y una escena en cada recuadro",
    categoria: "Cultura",
    fecha: "20 Mar 2026",
    minutos: 18,
    contenido: [
