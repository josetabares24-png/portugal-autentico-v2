          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{color: 'var(--color-primary)'}}>
                Planificar un viaje es agotador
              </h2>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl">
              ...
              <h3 className="text-2xl md:text-3xl font-bold mb-6" style={{color: 'var(--color-primary)'}}>
                Todo organizado por locales
              </h3>
              <div className="space-y-4 text-slate-600">
                <div className="flex items-start gap-3">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{color: 'var(--color-primary)'}}>
              Elige segun tus dias en Lisboa
            </h2>
...
ENDFILEcat > src/app/page.tsx << 'ENDFILE'
import Link from 'next/link';
