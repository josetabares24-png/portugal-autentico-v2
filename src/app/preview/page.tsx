      ...
      <section className="py-16" style={{background: 'var(--color-secondary)'}}>
        <div className="max-w-4xl mx-auto px-4">
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 bg-slate-50 rounded-xl p-5">
                    ...
                    <p className="text-slate-600 text-sm mb-4">El barrio mas antiguo de Lisboa. Callejuelas empedradas, ropa tendida, fado sonando desde las ventanas.</p>
                    <div className="flex flex-wrap gap-3 text-xs">
                      <span className="text-slate-500">Alfama, Lisboa</span>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 bg-amber-50 rounded-xl p-5 border border-amber-200">
                    ...
                    <p className="text-slate-600 text-sm mb-4">El mejor cafe de especialidad del barrio. Pide el pastel de nata con canela.</p>
                    <div className="flex flex-wrap gap-3 text-xs">
                      <span className="text-slate-500">Rua Cruzes da Se 29</span>
                      <span className="text-green-600 font-medium">3-5 EUR</span>
                    </div>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 bg-pink-50 rounded-xl p-5 border border-pink-200">
                    ...
                    <p className="text-slate-600 text-sm mb-4">El mirador mas fotografiado de Lisboa. Azulejos, buganvillas y vistas al rio Tejo.</p>
                    <div className="flex flex-wrap gap-3 text-xs">
                      <span className="text-pink-600 font-medium">Mejor luz: 9-11am</span>
                      <span className="text-green-600">Gratis</span>
                    </div>
                  </div>
                </div>
                <div className="bg-slate-100 rounded-xl p-6 text-center">
                  ...
                  <p className="text-slate-600 text-sm">Tarde en Belem, atardecer en el mejor mirador secreto, cena en tasca local.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="mt-12 text-center">
            ...
            <p className="text-slate-600 mb-8">El itinerario completo incluye todo el dia + restaurantes + mapas offline.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/itinerarios/lisboa-1-dia-lo-esencial" className="btn-primary inline-flex items-center justify-center gap-2 hover:scale-105 transition-all">Ver pack 1 dia - 5.99 EUR</Link>
              <Link href="/itinerarios" className="btn-secondary inline-flex items-center justify-center gap-2">Ver todos los packs</Link>
            </div>
          </div>
        </div>
      </section>
