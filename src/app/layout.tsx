          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex items-center space-x-1">
                ...
                <Link href="/apps" className="px-4 py-2 text-slate-600 hover:text-slate-900 rounded-lg font-medium transition-colors">Apps</Link>
              ...
              <details className="md:hidden relative">
                ...
                <div className="absolute right-0 top-12 w-64 bg-white rounded-xl shadow-xl border p-4 space-y-2">
                  ...
                  <Link href="/apps" className="block px-4 py-3 hover:bg-slate-50 rounded-lg font-medium">Apps</Link>
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-6">
              ...
              <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm">
                ...
                <Link href="/apps" className="text-slate-400 hover:text-white transition-colors">Apps</Link>
