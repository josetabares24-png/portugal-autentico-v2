...
const itinerarios = [
  {
    ...
    highlights: ["Castillo San Jorge", "Alfama", "Baixa", "Miradores"]
  },
  {
    slug: "lisboa-2-dias-completo",
    title: "Lisboa 2 Dias - Completo",
    description: "La experiencia completa. Belem, LX Factory y vida nocturna.",
    price: 37,
    duration: "2 dias",
    stops: 15,
    restaurants: 6,
  ...
  },
  {
    ...
    description: "Lisboa y alrededores. Sintra y Cascais incluidos.",
    price: 47,
    duration: "3 dias",
    stops: 22,
    restaurants: 9,
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Rutas optimizadas, mapas offline y restaurantes locales
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="space-y-8">
            {itinerarios.map((item) => (
              <div key={item.slug} className="bg-white rounded-3xl shadow-xl overflow-hidden">
                {item.popular && (
                ...
                <div className="md:flex">
                  <div className={"md:w-1/3 bg-gradient-to-br " + item.color + " flex items-center justify-center py-16"}>
                    <div className="text-center text-white">
                      ...
                      <p className="text-xl mt-2 opacity-90">dias</p>
                    </div>
                  </div>
                  <div className="md:w-2/3 p-8">
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="bg-slate-100 text-slate-700 px-3 py-1 rounded-full text-sm">{item.stops} paradas</span>
                      <span className="bg-slate-100 text-slate-700 px-3 py-1 rounded-full text-sm">{item.restaurants} restaurantes</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                      ...
                      <Link href={"/itinerarios/" + item.slug} className={"bg-gradient-to-r " + item.color + " text-white px-8 py-4 rounded-xl font-bold hover:shadow-lg"}>
                        Ver Detalles
                      </Link>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-300 text-lg">
            Si no estas satisfecho, te devolvemos el dinero. Sin preguntas.
          </p>
        </div>
      </section>
    </main>
