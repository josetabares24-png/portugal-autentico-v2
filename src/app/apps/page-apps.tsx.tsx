      ...
      <section className="relative min-h-[50vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 py-16">
          ...
          <p className="text-base md:text-lg text-white/80 max-w-xl mx-auto">
            Las aplicaciones que usamos nosotros y que te harán la vida más fácil.
          </p>
        </div>
      </section>
      ...
      <section className="py-6 bg-white border-b">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-center gap-3 text-sm">
            ...
            <span className="text-slate-600"><span className="font-semibold text-amber-600">Consejo:</span> Descarga todas las apps antes de viajar.</span>
          </div>
        </div>
      </section>
                ...
                <div key={app.name} className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-slate-100">
                  <div className="p-6">
                    <div className="flex items-start gap-4 mb-4">
                      <div className="w-14 h-14 rounded-xl overflow-hidden bg-slate-50 flex items-center justify-center flex-shrink-0 p-2 border border-slate-100">
                    ...
                    <div className="flex gap-2 pt-4 border-t border-slate-100">
                      <a href={app.appStore} target="_blank" rel="noopener noreferrer" className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-slate-900 text-white text-xs font-medium rounded-lg hover:bg-slate-800 transition-colors">App Store</a>
                      <a href={app.playStore} target="_blank" rel="noopener noreferrer" className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-slate-100 text-slate-700 text-xs font-medium rounded-lg hover:bg-slate-200 transition-colors">Play Store</a>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section className="py-20" style={{background: 'var(--color-secondary)'}}>
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl text-center">
            ...
            <p className="text-slate-600 text-lg mb-8 max-w-2xl mx-auto">Nuestros packs incluyen rutas, restaurantes, horarios y todos los secretos locales.</p>
